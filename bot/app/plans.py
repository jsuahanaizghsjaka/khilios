...
class Plan:
    ...
    #
    # СВЕРИТЬ ПЕРЕД ЗАПУСКОМ. Числа ниже — отправная точка, а не курс:
    # откройте у себя покупку Stars и посмотрите, сколько рублей стоит
    # нужное количество. Расхождение с рублёвой ценой больше чем на 10%
    # в любую сторону — это либо потерянная выручка, либо жалоба.
    price_stars: int = 0
