...
const FEATURES = [
  ...
  },
  {
    ...
    body: <>Не «ведутся работы», а что именно легло, с какого времени и когда починим.</>,
  },
  {
    icon: IconRefund,
...
export default function Home() {
  ...
  return (
    <>
      {/* Сфера-герой. Заголовок сменён после сверки с правовым заключением.
          Предыдущий — «работает, когда не работает ничего» — не содержал
          запрещённых слов, но по смыслу читался как обещание обхода
          ограничений. Продающая сила у него была выше, а отстройка проекта
          всё равно не в заголовке, а в публичном статусе, возвратах и в том,
          что мы не исчезаем. */}
